...
class Game {
  ...
  displaySuccessMessage() {
    ...
    setTimeout(function(){$('#right').html("Correcto!!!")},500)
    setTimeout(() => {$('#right').html("Felicitaciones!!! gano " + this.amount)},1800)
    setTimeout(function(){$('#right').html("Siguiente pregunta")},3800)
    setTimeout(function(){
  ...
  displayWinnerMessage() {
    $('.right-wrapper').fadeIn(800);
    setTimeout(function(){$('#right').html("Correcto!!!")},500)
    setTimeout(function(){$('#right').html("Felicitaciones!!! gano")}, 1800)
    setTimeout(() => {
  ...
  wrongAnswer() {
    ...
    setTimeout(() => {
      $('#wrong').html(`NO!!!<br>Tenia ${this.amount}`)
    },100)
  ...
  callFriendLifeline() {
    ...
    let friends = ["Juan", "Pedro", "Jose", "Carola", "Maria", "Andres", "Antonieta"]
